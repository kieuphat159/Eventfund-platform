...
import { Wallet as WalletIcon, Send, Download, ArrowUpRight, ArrowDownLeft } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-400">Manage your digital assets and transactions</p>
      </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-3 mt-1">
                      ...
                      <code className="text-xs text-slate-500 bg-slate-900 px-2 py-1 rounded">{tx.hash}</code>
                    </div>
                  </div>
                </div>
